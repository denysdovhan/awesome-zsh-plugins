...
* [zsh-autopair ![GitHub stars](https://img.shields.io/github/stars/hlissner/zsh-autopair.svg)](https://github.com/hlissner/zsh-autopair) - A ZSH plugin for auto-closing, deleting and skipping over matching delimiters.
...
* [zsh-cmd-architect ![GitHub stars](https://img.shields.io/github/stars/psprint/zsh-cmd-architect.svg)](https://github.com/psprint/zsh-cmd-architect) - build commands from what's in history and at prompt, move, delete, add command segments and search history with multi-word queries
...
* [duell ![GitHub stars](https://img.shields.io/github/stars/jcxavier/oh-my-zsh-duell.svg)](https://github.com/jcxavier/oh-my-zsh-duell) - A zsh plugin for [duell](https://github.com/gameduell/duell)
...
* [gulp-autocompletion-zsh ![GitHub stars](https://img.shields.io/github/stars/srijanshetty/gulp-autocompletion-zsh.svg)](https://github.com/srijanshetty/gulp-autocompletion-zsh) - Autocompletion for gulp
...
* [zsh-ipfs ![GitHub stars](https://img.shields.io/github/stars/aramboi/zsh-ipfs.svg)](https://github.com/aramboi/zsh-ipfs) - Completions for the [Interplanetary File System](http://ipfs.io/)
...
* [exercism ![GitHub stars](https://img.shields.io/github/stars/fabiokiatkowski/exercism.plugin.zsh.svg)](https://github.com/fabiokiatkowski/exercism.plugin.zsh) - A plugin for [exercism.io](http://exercism.io/).
* [frisk-arrow ![GitHub stars](https://img.shields.io/github/stars/BakeRolls/frisk-arrow.svg)](https://github.com/BakeRolls/frisk-arrow) - A theme based on the [frisk](https://github.com/robbyrussell/oh-my-zsh/blob/master/themes/frisk.zsh-theme) oh-my-zsh-theme.
...
* [girazz ![GitHub stars](https://img.shields.io/github/stars/mdentremont/girazz.svg)](https://github.com/mdentremont/girazz) - A modification to the gnzh theme which adds VI mode to the right prompt.
...
* [hackerquotes ![GitHub stars](https://img.shields.io/github/stars/oldratlee/hacker-quotes.svg](https://github.com/oldratlee/hacker-quotes) - Outputs a hacker quote randomly when you open a terminal
* [hackersaurus ![GitHub stars](https://img.shields.io/github/stars/bhilburn/hackersaurus.svg)](https://github.com/bhilburn/hackersaurus) - A theme with git status and exit code of last command run embedded in the prompt. Related to [powerlevel9k](https://github.com/bhilburn/powerlevel9k).
